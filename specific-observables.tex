...
\begin{equation}
  C_j = \dfrac{
    % The weird white "j" and negative hspace is to make the parentheses/square brackets the same size
    ...
    %\right>
    \overline{
      \left( q_{k{\color{white}j}}\hspace{-1pt} - \bar{q} \right)
      \left( q_{k+j} - \bar{q} \right)
    }
  }
  {s\left(q_k\right)^2}
