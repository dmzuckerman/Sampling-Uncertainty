...
For a derived observable that is a linear function of uncorrelated raw data, e.g.,
%
\begin{equation}
...
\begin{equation}
  ...
  %+ 2 \sum_{i=1}^{M-1} \sum_{j=i+1}^M a_i a_j \text{Cov}\left(x_i,x_j\right)
...
\begin{equation}
  ...
  + \sum_{i=1}^M \left.
    \left( \dfrac{\partial F}{\partial x_i}\right)_{x_{j \neq i}}
