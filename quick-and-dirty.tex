...
%are typically the Cartesian coordinates of atom $i$ in configurations $\mathbf{r}$ and $\mathbf{s}$ respectively; sometimes only a subset of atoms is considered (e.g., backbone heavy atoms in a protein.
