...
To illustrate these points, consider the initial configuration of a protein that has been energy-minimized and otherwise relaxed from a crystal structure.
...
%PNP comment: The first two sentences of this paragraph seem contradictory.  The first suggests we consider a system that has been relaxed from a crystal structure.  Does this relaxation make the system amorphous, or is it just a relaxed crystal?  Also, the phrase, "e.g. crystal packing etc." doesn't make a lot of sense to me.  I think this needs to either be removed or expanded.  Is the idea that aquaeous environments dissolve crystals?  If so, say this more directly.
