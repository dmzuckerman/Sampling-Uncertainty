...
Such an initial structure might seem to be intrinsically valuable, but remember that configurations important in a crystal environment may not be equally pertinent to an aqueous environment due to e.g. crystal packing etc. Also, any energy minimization/relaxation that has been performed likely will be very local and keep the configuration within or nearby the initial energy basin.
See the RMSD trace in Fig.\ \ref{f:rmsd}, and note the very rapid RMSD increase in the first $\sim$200 ns. This indicates that the initial conformation was not favorable for the given conformation/simulation conditions. This rapid relaxation to a new conformation is inherently a non-equilibrium process and should not be included in the calculation of equilibrium properties.
